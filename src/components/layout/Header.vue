                                                ...
                                                <div class="header_banner_content">
                                                    <div class="shop_banner">
                                                        <div class="banner_img overlay_bg_40">
                                                            <img src="/assets/images/shop_banner.jpg"
                                                                alt="shop_banner" />
                                                        </div>
                            ...
                            <div class="cart_box dropdown-menu dropdown-menu-right" v-if="cart.items.length > 0">
                                <ul class="cart_list">
                                    <li v-for="item in cart.items" :key="item.id">
                                        <a href="javascript:void(0)" class="item_remove" @click.prevent="cart.removeCartItem(item.id)"><i class="ion-close"></i></a>
                                        <a href="#"><img src="/assets/images/cart_thamb1.jpg" alt="cart_thumb1">
                                            {{ item.product.title }}
                                        </a>
                                        <span class="cart_quantity"> 1 x <span class="cart_amount"> <span
                                                    class="price_symbole">$</span></span>{{ item.product.price }}</span>
                                    </li>
                                </ul>
                                <div class="cart_footer">
                                    <p class="cart_total"><strong>Subtotal:</strong> <span class="cart_price"> <span
                                                class="price_symbole">$</span></span>{{ cart.subtotal }}</p>
                                    <p class="cart_buttons">
                                        <router-link to="/dashboard/carts" class="btn btn-fill-line rounded-0">View Cart</router-link>
